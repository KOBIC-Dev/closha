...
public class OpenInternalNestedWorkflowFeatureProvider implements ICustomFeatureProvider
{
	...
	/* (non-Javadoc)
	 * @see org.kobic.bioexpress.workbench.editor.features.ICustomFeatureProvider#createFeature(org.eclipse.graphiti.features.IFeatureProvider, java.lang.String, java.lang.String)
	 */
	@Override
