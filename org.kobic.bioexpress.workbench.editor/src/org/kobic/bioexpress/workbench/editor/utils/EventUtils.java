...
public class EventUtils {
	...
	/**
	 * Returns the model object 'window', which will be an active window. May return
	 * null.
	 * 
	...
	/**
	 * Registers the specified event handler for invocation for the specified topic
	 * 
	 ...
	 */
	public static boolean registerForEvent(final String topic, final EventHandler handler) {
	 ...
	 * @return True if the registration worked; false otherwise
	 */
	public static boolean registerForEvent(final String topic, final EventHandler handler, final IEventBroker broker) {
		boolean bRet = false;
	...
	/**
	 * Unregisters the specified event handler from the event system; since there is
	 * no topic specified, it is not possible to stop listening for just certain
	 * topics.
	 */
