...
public class PaletteTreeViewer extends PaletteViewer {
	...
	public void setPaletteRoot(PaletteRoot root) {
		...
		List list = getRootEditPart().getContents().getChildren();
	...
	public Control createTreeControl(Composite parent) {
		...
		//
		//
		//String path = WorkflowImageProvider.get().getImageFilePath(WorkflowImageProvider.IMG_PALETTE_TITLE);	
		//ImageDescriptor descriptor = WorkflowEditorPlugin.getImageDescriptor(path);
		//Image image = descriptor.createImage();
		//getControl().getShell().setImage(image);
		return tree;
	}
