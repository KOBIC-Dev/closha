...
public class FileTreeViewContentProvider implements ITreeContentProvider {

	final static Logger logger = Logger.getLogger(FileTreeViewContentProvider.class);
	...
	public Object[] getChildren(Object parentElement) {
		...
		List<FileModel> files = Activator.getFileService().getFiles(file.getPath());
