...
public class PipelineDetailTreeViewLabelProvider extends LabelProvider implements IStyledLabelProvider {

	final static Logger logger = Logger.getLogger(PipelineDetailTreeViewLabelProvider.class);
