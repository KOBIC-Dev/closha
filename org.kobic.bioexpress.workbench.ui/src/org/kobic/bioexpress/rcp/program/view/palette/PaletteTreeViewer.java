...
//				getEditDomain().mouseMove(me, PaletteTreeViewer.this);
	 ...
	 * <p>
	 * Doesn't use the default createControl method name, as that one is made final
	 * in the ScrollingGraphicalViewer base class...
	 * </p>
	 *
	...
	protected void hookControl() {
		...
		tree.addSelectionListener(new SelectionListener() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if (newSelection.length > 0 && newSelection[0] instanceof PaletteEntryEditPart) {
					Object model = ((PaletteEntryEditPart) newSelection[0]).getModel();
	...
	// Handle active Tool selection (override to allow cast from
	// PaletteEntryEditPart)
	...
	protected void fireModeChanged() {
		...
		for (int listener = 0; listener < paletteListeners.size(); listener++)
			paletteListeners.get(listener).activeToolChanged(this, activeTool);
	}
